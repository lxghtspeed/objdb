	...
	private static serialize(o: Options, references: Object[] = []): Reference | Primitive {
		...
		if (typeof type === 'string') {
			...
			if (!names.includes(type)) {
				console.warn(`objdb/serialization WARNING: "${type}" is not added to the constructors list, this will result into a thrown error at the next startup if you don't add it.`);
			}
